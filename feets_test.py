...
data_path = os.path.abspath('atlas_db/')

obj_tab = fits.getdata(os.path.join(data_path, 'CBF_objects_bos0109.fit'))

det_tab = fits.getdata(os.path.join(data_path, 'CBF_detection_bos0109.fit'))
